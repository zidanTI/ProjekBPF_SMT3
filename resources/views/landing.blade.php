...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@9/public/assets/css/swiper-bundle.min.css" />
                    ...
                    <div class="swiper-wrapper d-flex border-animation-left">
                        <div class="swiper-slide">
                            <div class="banner-item image-zoom-effect">
                                <div class="image-holder">
                                    <a href="#">
                                        <img src="{{ asset('assets/images/banner-image-6.jpg') }}" alt="product"
                                            class="img-fluid">
                        ...
                        <div class="swiper-slide">
                            <div class="banner-item image-zoom-effect">
                                <div class="image-holder">
                                    <a href="#">
                                        <img src="{{ asset('assets/images/banner-image-1.jpg') }}" alt="product"
                                            class="img-fluid">
                                    </a>
                                </div>
                                <div class="banner-content py-4">
                        ...
                        <div class="swiper-slide">
                            <div class="banner-item image-zoom-effect">
                                <div class="image-holder">
                                    <a href="#">
                                        <img src="{{ asset('assets/images/banner-image-2.jpg') }}" alt="product"
                                            class="img-fluid">
                                    </a>
                                </div>
                                <div class="banner-content py-4">
                        ...
                        <div class="swiper-slide">
                            <div class="banner-item image-zoom-effect">
                                <div class="image-holder">
                                    <a href="#">
                                        <img src="{{ asset('assets/images/banner-image-3.jpg') }}" alt="product"
                                            class="img-fluid">
                                    </a>
                                </div>
                                <div class="banner-content py-4">
                        ...
                        <div class="swiper-slide">
                            <div class="banner-item image-zoom-effect">
                                <div class="image-holder">
                                    <a href="#">
                                        <img src="{{ asset('assets/images/banner-image-4.jpg') }}" alt="product"
                                            class="img-fluid">
                                    </a>
                                </div>
                                <div class="banner-content py-4">
                        ...
                        <div class="swiper-slide">
                            <div class="banner-item image-zoom-effect">
                                <div class="image-holder">
                                    <a href="#">
                                        <img src="{{ asset('assets/images/banner-image-5.jpg') }}" alt="product"
                                            class="img-fluid">
                                    </a>
                                </div>
                                <div class="banner-content py-4">
                ...
                <div class="swiper-wrapper d-flex">
                    <div class="swiper-slide">
                        <div class="product-item image-zoom-effect link-effect">
                            <div class="image-holder position-relative">
                                <a href="index.html">
                                    <img src="{{ asset('assets/images/product-item-1.jpg') }}" alt="categories"
                                        class="product-image img-fluid">
                                </a>
                    ...
                    <div class="swiper-slide">
                        <div class="product-item image-zoom-effect link-effect">
                            <div class="image-holder position-relative">
                                <a href="index.html">
                                    <img src="{{ asset('assets/images/product-item-2.jpg') }}" alt="categories"
                                        class="product-image img-fluid">
                                </a>
                                <a href="index.html" class="btn-icon btn-wishlist">
                                    <svg width="24" height="24" viewBox="0 0 24 24">
                    ...
                    <div class="swiper-slide">
                        <div class="product-item image-zoom-effect link-effect">
                            <div class="image-holder position-relative">
                                <a href="index.html">
                                    <img src="{{ asset('assets/images/product-item-3.jpg') }}" alt="categories"
                                        class="product-image img-fluid">
                                </a>
                                <a href="index.html" class="btn-icon btn-wishlist">
                                    <svg width="24" height="24" viewBox="0 0 24 24">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu footer-menu-004 border-animation-left">
                        ...
                        <p>Do you need support? Give us a call. <a href="tel:+43 720 11 52 78"
                                class="item-anchor">+43 720 11 52
                                78</a>
                        </p>
                    </div>
                </div>
